...
The aim is to make a Docker-based multi-container architecture that separates the backend (code analysis part), vector database service, data visualisation and frontend interface.
